 ...
 */
final class Version20200425142746 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contenu_panier CHANGE panier_id panier_id INT DEFAULT NULL, CHANGE produit_id produit_id INT DEFAULT NULL, CHANGE quantity quantity VARCHAR(255) DEFAULT NULL');
