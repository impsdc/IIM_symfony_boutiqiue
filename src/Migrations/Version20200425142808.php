 ...
 */
final class Version20200425142808 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contenu_panier CHANGE produit_id produit_id INT DEFAULT NULL, CHANGE panier_id panier_id INT DEFAULT NULL, CHANGE quantity quantity VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE panier CHANGE user_id user_id INT DEFAULT NULL, CHANGE date date DATETIME DEFAULT \'NULL\'');
